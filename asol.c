...
int readAndParse(FILE *, char *, char *, char *, char *, char *, char*);
...
int main(int argc, char *argv[])
{
	...
	arg1[MAXLINELENGTH], arg2[MAXLINELENGTH], argTmp[MAXLINELENGTH], bit[MAXLINELENGTH];
    int i;
    int numLabels=0;
    int num;
    int addressField;
    ...
    for (address=0; readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2, bit);
	    address++) {
	/*
	printf("%d: label=%s, opcode=%s, arg0=%s, arg1=%s, arg2=%s, bit=%s\n",
	    address, label, opcode, arg0, arg1, arg2, bit);
	*/
    ...
    for (address=0; readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2, bit);
		...
		if (!strcmp(opcode, "add")) {
			num = (ADD << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "nand")) {
			num = (NAND << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "jalr")) {
			num = (JALR << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9);
		} else if (!strcmp(opcode, "halt")) {
			num = (HALT << 15);
		} else if (!strcmp(opcode, "div")) {
			num = (DIV << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "xadd")) {
			num = (XADD << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "xidiv")) {
			num = (XIDIV << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "and")) {
			num = (AND << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "xor")) {
			num = (XOR << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "cmpl")) {
			num = (CMPL << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "setbr")) {
			num = (SETBR << 15) | (atoi(arg0) << 12);
		} else if (!strcmp(opcode, "sbb")) {
			num = (SBB << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		} else if (!strcmp(opcode, "bt")) {
			num = (BT << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9);
		} else if (!strcmp(opcode, "rcr")) {
			num = (RCR << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) | atoi(arg2) << 1;
		}
			...
			/* if arg2 is symbolic, then translate into an address */
			 ...
			 if (addressField < -128 || addressField > 127)
			 {
			...
			/* truncate the offset field, in case it's negative */
			 addressField = addressField & 0xFF;
			 if (!strcmp(opcode, "jmae")) {
				 num = (JMAE << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) |
					 addressField << 1 | (atoi(bit) << 0);
			 }
			 else if (!strcmp(opcode, "jmle")) {
				num = (JMLE << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) |
					addressField << 1 | (atoi(bit) << 0);
			 }
			 else if (!strcmp(opcode, "beq")) {
				num = (BEQ << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) |
					 addressField << 1;
			 }
			 else {
				if (!strcmp(opcode, "lw")) {
					num = (LW << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) |
						addressField << 1 | (atoi(bit) << 0);
				}
				else if (!strcmp(opcode, "sw")) {
					num = (SW << 15) | (atoi(arg0) << 12) | (atoi(arg1) << 9) |
						addressField << 1 | (atoi(bit) << 0);
				}
			 }
		     }
...
int readAndParse(FILE* inFilePtr, char* label, char* opcode, char* arg0, char* arg1, char* arg2, char* bit)
{
    ...
    /* delete prior values */
    label[0] = opcode[0] = arg0[0] = arg1[0] = arg2[0] = bit[0] = '\0';
